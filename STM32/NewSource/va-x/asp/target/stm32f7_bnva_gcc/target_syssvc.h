 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 698 2015-09-27 15:03:56Z roi $
 */

/*
 *  システムサービスのターゲット依存部（stm32f7-discovery用）
 *
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME    "stm32f7-bnva(Cortex-M7)"
...
"Copyright (C) 2017 by Bionics co.,ltd.\n" \
...
//#define BPS_SETTING		(460800)
#define BPS_SETTING		(921600)
