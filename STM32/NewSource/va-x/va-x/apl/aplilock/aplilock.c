...
void aplilock_task(intptr_t exinf)
{
    ...
    while (true) {
        DBGLOG0("aplilock_task() while-starts.");
...
void drvlilock_callback(int32_t evt, int32_t error)
{
    ...
    case DRVLLOCK_EVT_CONECT_COMP:
        ...
        aplevt_send_event(APLEVT_LINKEY_READY, 0, NULL, s_event_dest);
        break;
    case DRVLLOCK_EVT_OPEN_STATUS:
        ...
        aplevt_send_event(APLEVT_LINKEY_COMPLETE, 0, NULL, s_event_dest);
        break;
